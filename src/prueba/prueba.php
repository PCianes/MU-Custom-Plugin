<?php
/**
 * Prueba Module Handler - bootstrap file for the module.
 *
 * @package     PCianes\Module\Prueba
 * @since       1.0.0
 * @author      Pablo Cianes
...
namespace PCianes\Module\Prueba;

add_action( 'cmb2_admin_init', __NAMESPACE__ .'\yourprefix_register_demo_metabox' );
/**
